...
<img src="<?= base_url() ?>/assets/adminlte/dist/img/dukcapil.png" align="left" width="10%">
    ...
    <h5><b><?= $label ?></b></h5>
        <h3 align="center"><b>Laporan Penerbitan Akta Lahir</b></h3><br>
        ...
        <th>Status</th>
            ...
            <tbody>
                    <?php 
                    $no=0;
                    foreach($tbl_aktalahir as $isi)
                    {
                    ?>
                            <tr>
                                <td><?= ++$no; ?></td>
                                <td><?= $isi->nama_bayi;?></td>
                                <td><?= $isi->jenis_kelamin_bayi;?></td>
                                <td><?= $isi->tempat_lahir_bayi;?></td>
                                <td><?= $isi->tgl_lahir_bayi;?></td>
                                <td><?= $isi->no_akta;?></td>
                                <td><?= $isi->no_kk;?></td>
                                <td><?= $isi->tgl_input;?></td>
                                <td><?= $isi->status;?></td>
