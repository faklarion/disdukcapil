...
<html>
    ...
    <h5><b><?= $label ?></b></h5>
        <h3 align="center"><b>Laporan Penerbitan Akta Perceraian</b></h3><br>
        ...
        <tbody>
		      ...
		      <td><?php echo $isi->tgl_perkawinan ?></td>
		      <td><?php echo $isi->tgl_perceraian ?></td>
              <td><?php echo $isi->tgl_input_cerai ?></td>
