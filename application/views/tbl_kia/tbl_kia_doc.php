...
<html>
    ...
    <h5><b><?= $label ?></b></h5>
        <h3 align="center"><b>Laporan Penerbitan Kartu Identitas Anak (KIA)</b></h3><br>
        ...
        <tbody>
                    <?php 
                    $no=0;
                    foreach($tbl_kia as $isi)
                    {
                    ?>
                            <tr>
		      <td><?php echo ++$no ?></td>
		      <td><?php echo $isi->pemohon ?></td>
		      <td><?php echo $isi->jenis_kelamin_bayi ?></td>
		      <td><?php echo $isi->tempat_lahir_bayi. ' ' . $isi->tgl_lahir_bayi?></td>
		      <td><?php echo $isi->nik ?></td>
		      <td><?php echo $isi->no_kk ?></td>
		      <td><?php echo $isi->no_akta ?></td>
		      <td><?php echo $isi->nama ?></td>	
              <td><?php echo $isi->tgl_input_kia ?></td>	
              </tr>
