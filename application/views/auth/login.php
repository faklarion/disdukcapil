  ...
  background-size: 100% 100%;">
        <div class="login-box">
            ...
            <p align="center"><img src="<?php echo base_url() ?>assets/adminlte/dist/img/dukcapil.png" width="35%" height="35%" class="img-box"></p>
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b>DISDUKCAPIL  </b> BANJARMASIN</a>
            </div>
                <?php
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <?php echo anchor(site_url('register/create'), '<i class="fa fa-create" aria-hidden="true"></i> Daftar Akun', 'class="btn btn-success  btn-block btn-flat"'); ?>
                    </div>
                </div>
                <!-- /.col -->
