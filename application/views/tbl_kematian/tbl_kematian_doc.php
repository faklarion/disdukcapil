...
<html>
    ...
    <h5><b><?= $label ?></b></h5>
        <h3 align="center"><b>Laporan Penerbitan Akta Kematian</b></h3><br>
		...
		<th>Tanggal Terbit</th>
		      ...
		      <td><?php echo $isi->tgl_kematian ?></td>
		      <!--<td><?php echo $isi->no_akta ?></td>-->
		      <td><?php echo $isi->tgl_input_kematian ?></td>
                </tr>
                <?php
            }
            ?>
